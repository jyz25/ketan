package com.ketan.core.util.id;

import com.ketan.core.async.AsyncUtil;
import com.ketan.core.util.CompressUtil;
import com.ketan.core.util.id.snowflake.PaiSnowflakeIdGenerator;
import com.ketan.core.util.id.snowflake.SnowflakeProducer;

import static com.ketan.core.util.CompressUtil.int2str;
